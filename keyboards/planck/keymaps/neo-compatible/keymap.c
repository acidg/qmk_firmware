 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  FN  | Gui  | Alt  | Caps | Ctrl |Space | Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, FN,      KC_LGUI, KC_LALT, KC_CAPS, KC_LCTL, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_FN] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
    KC_LCTL, _______, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RCTL
)
